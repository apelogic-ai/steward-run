...
The v0.6.0 chart and runner include authentication discovery and system trust
by default. Follow the [current installation guide](../../docs/installation.md)
and pull the chart from the public repository with:

```sh
helm pull oci://ghcr.io/apelogic-ai/charts/steward-run-arc --version 0.6.0
```

The matching runner tag is `ghcr.io/apelogic-ai/steward-run:0.6.0`. Tags are
